...
export default async function HomePage({ params: { locale } }: HomePageProps) {
  ...
  return (
    <StorefrontLayout locale={locale}>
      {/* Hero */}
      <section className="relative bg-brand-brown text-brand-cream overflow-hidden min-h-[420px] md:min-h-[520px]">
        ...
        <div className="absolute bottom-0 left-0 w-[72%] md:w-[55%] h-full pointer-events-none select-none">
          <Image
            ...
            style={{ mixBlendMode: "multiply", transform: "scale(1.75)", transformOrigin: "bottom left" }}
          />
        </div>
